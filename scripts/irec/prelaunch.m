...
target_apogee_ft = 10700;
mass_min_kg      = 0.0;
mass_max_kg      = 2.5;
tolerance_ft     = 10;
pucks_g          = [1645 795 390 195 95 45];

cache_dir = fullfile(pwd,'scripts\irec\airdata_cache');   % same folder used by creator script
% --------------------------------------------------------------------
...
% 1) Optimal Nose Mass
nexttile
plot(launch_window, optimal_masses_kg, '-o','LineWidth',1.5)
...
% Optional: tilt x-labels if crowded
xtickangle(45)
